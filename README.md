...
If you don't know what to do, see this [tutorial](https://opentutorials.org/module/432/3742) video.

Also, because the escue only does support archive installation, the elasticsearch must be downloaded from 
